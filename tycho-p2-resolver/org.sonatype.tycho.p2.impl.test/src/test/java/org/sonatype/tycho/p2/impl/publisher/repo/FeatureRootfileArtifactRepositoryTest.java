...
public class FeatureRootfileArtifactRepositoryTest
{
        ...
        throws Exception
    {
        ...
        assertAttachedArtifact( subject.getAttachedArtifacts(), 1, "root", "org.sonatype.tycho.test.p2-1.0.0-root.zip" );
        ...
        throws Exception
    {
        ...
        assertAttachedArtifact( subject.getAttachedArtifacts(), 1, "root.win32.win32.x86",
    ...
    public void testRepoWithoutMavenAdvise()
        throws ProvisionException
    {
        FeatureRootfileArtifactRepository subject =
            new FeatureRootfileArtifactRepository( createPublisherInfo( false ) );
        ...
        throws ProvisionException
    {
        ...
        Map<String, IArtifactFacade> attachedArtifacts = subject.getAttachedArtifacts();
    ...
    {
        FeatureRootfileArtifactRepository subject = new FeatureRootfileArtifactRepository( null );
        Assert.assertTrue( subject.getAttachedArtifacts().isEmpty() );
    }
